...
urlpatterns = [
    ...
    path('toggle_favorite/<int:post_id>/',
         toggle_favorite, name='toggle_favorite'),
    path('favorites/', favorites, name='favorites'),
    path('delete_gem/<int:post_id>/', views.delete_gem, name='delete_gem'),
    path('posts_by_region/<int:region_id>/',
         views.posts_by_region, name='posts_by_region'),
    path('post/<int:post_id>/', views.gem_detail, name='gem_detail'),
    path('post/<int:post_id>/comment/<int:comment_id>/edit/',
