...
class Post(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Overridden save method. If the post doesn't have a slug, it generates one 
        from the title. If the generated slug already exists, it appends a random 
        string to the title to generate a unique slug.
        """
        if not self.slug:
